...
# You are given a uniform grid of gray squares in the beginning of the game. Each square contains either a mine 
# (indicated by a value of 9), or an empty square. Empty squares have a number indicating the count of mines in 
# the adjacent squares. Empty squares can have counts from zero (no adjacent mines) up to 
# 8 (all adjacent squares are mines).
